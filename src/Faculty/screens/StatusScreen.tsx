...
type AppScreen = 'FacultyChats' | 'ChatThemeSelection';
...
export default function StatusScreen() {
  ...
  const [currentScreen, setCurrentScreen] = useState<AppScreen>('FacultyChats');
  ...
  if (currentScreen === 'ChatThemeSelection') {
    return <ChatThemeSelectionScreen onBack={() => setCurrentScreen('FacultyChats')} />;
  }

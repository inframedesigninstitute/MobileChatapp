...
//   { id: '1', name: 'Vikram Choudhary', lastMessage: '✓✓ signon name father name batch course...', time: '12:07 am', unread: 1, isStarred: false, type: 'personal' },
...
//   { id: '4', name: '+91 8765987643', lastMessage: 'Internet services have been resumed...', time: 'Yesterday', unread: 0, isStarred: false, type: 'personal' },
//   { id: '5', name: 'Code Step by Step 🧠', lastMessage: '+91 63826 37219 joined using a group...', time: 'Yesterday', unread: 1, isStarred: false, type: 'group' },
//   { id: '6', name: 'Sunil 🍪😊', lastMessage: '✓✓ 📷 Photo', time: 'Yesterday', unread: 0, isStarred: true, type: 'personal' },
//   { id: '7', name: 'Business Group', lastMessage: 'Announcements ▸ HCL...', time: '9:36 am', unread: 3, isStarred: false, type: 'group' },
//   { id: '8', name: 'Educational Group', lastMessage: '✓✓ cha.zip', time: '9:36 am', unread: 0, isStarred: true, type: 'group' },
//   { id: '9', name: 'Rahul', lastMessage: 'gfdgf', time: '8:06 am', unread: 2, isStarred: false, type: 'personal' },
//   { id: '10', name: 'Family Group', lastMessage: 'Good morning everyone!', time: '7:50 am', unread: 5, isStarred: false, type: 'group' },
// ];
